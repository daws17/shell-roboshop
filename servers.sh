...
do
    ...
    INSTANCE_ID=$(aws ec2 run-instances --image-id ami-ami-09c813fb71547fc4f --instance-type t3.micro --security-group-ids sg-sg-00434aea2a5a1cc91 --tag-specifications 'ResourceType=instance,Tags=[{Key=Name,Value=$instance}]'--query "Instances[0].InstanceId" --output text)
